// import 'package:supabase_flutter/supabase_flutter.dart'; // 已注释，改用独立后端接口
...
class AuthErrorHandler {
  ...
  // static String _handleAuthException(AuthException error) { // 已注释，改用独立后端接口
  ...
  // static String _handlePostgrestException(PostgrestException error) { // 已注释，改用独立后端接口
  //   switch (error.code) {
